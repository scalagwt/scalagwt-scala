...
class ReflectiveRunner {
  ...
  def main(args: String) {
    ...
    import fileManager.
      { latestCompFile, latestLibFile, latestPartestFile, latestFjbgFile, latestProtobufFile, latestScalapFile }
    val files =
      Array(latestCompFile, latestLibFile, latestPartestFile, latestFjbgFile, latestProtobufFile, latestScalapFile) map (x => io.File(x))
